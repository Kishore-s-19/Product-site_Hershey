export interface Product {
    ...
    themeColor: string;
    gradient: string;
    imageExtension?: string; // Added to support jpg/webp
    features: string[];
...
export const products: Product[] = [
    {
        ...
        section1: { title: "Hershey Chocolate.", subtitle: "Velvety smooth." },
        ...
        freshnessSection: {
            ...
            description: "Heat destroys delicate cocoa flavonoids. That's why we mix our Hershey Chocolate cold. Our almond milk is pressed fresh daily, never stored. The result is a clean, robust chocolate flavor that feels heavy on the tongue but light on the stomach."
        },
        buyNowSection: {
            price: "₹34",
            unit: "per 180ml bottle",
